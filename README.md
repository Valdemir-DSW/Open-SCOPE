...
O cliente suporta pacotes SCP1 com até **4 canais** (o firmware STM32F103 pode habilitar o quarto canal opcionalmente), inclui analisador de rede elétrica, ferramenta de sequência de fase e carregamento manual de plugins Python pela pasta `plugins`. Desenvolvimento: **Valdemir**.
